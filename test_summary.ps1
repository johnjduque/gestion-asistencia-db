...
$criticalIds = @(
    ...
    'MATRICULA_NOT_IMPLEMENTED',
    'TITULARIDAD_UUID_USUARIO_DISTINTO_DE_ROL', 'TITULARIDAD_DOCENTE_PROPIETARIO', 'TITULARIDAD_COORDINADOR_PROPIETARIO',
    'TITULARIDAD_DECANO_PROPIETARIO', 'TITULARIDAD_DOCENTE_AJENO_RECHAZADO', 'TITULARIDAD_COORDINADOR_AJENO_RECHAZADO',
    'TITULARIDAD_DECANO_AJENO_RECHAZADO', 'TITULARIDAD_E2E_REGISTRO_ASISTENCIA',
    'ROUNDTRIP_BATCH_AN_SJC_EX_SUCCESS', 'ROUNDTRIP_AN_SJC_EX_EXACT_MATCH',
    'RAZON_CAUSA_CODIGO_INVALIDO_RECHAZADO', 'RAZON_CAUSA_SIN_CREACION_DINAMICA',
    'ATOMICIDAD_LOTE_MIXTO_ROLLBACK_TOTAL', 'INTEGRIDAD_ESTUDIANTE_FUERA_DE_GRUPO_RECHAZADO',
    'INTEGRIDAD_SESION_INEXISTENTE_RECHAZADA',
