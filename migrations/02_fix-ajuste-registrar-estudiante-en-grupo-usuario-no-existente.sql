...
/****** Object:  StoredProcedure [dbo].[usp_registrar_estudiante_en_grupo_usuario_no_existente]    Script Date: 20/07/2026 7:21:31 p. m. ******/
DROP PROCEDURE IF EXISTS [dbo].[usp_registrar_estudiante_en_grupo_usuario_no_existente]
GO
