...
/****** Object:  StoredProcedure [dbo].[usp_registrar_estudiante_en_grupo]    Script Date: 22/07/2026 10:26:06 p. m. ******/
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Validación de Grupo
        IF @estadoResultado = 1 BEGIN
            EXEC dbo.usp_validar_grupo_exista_por_id @idGrupo_interno = @grupoDefecto, @idCorrelacion = @idCorrelacionDefecto, @mensajeUsuarioResultado = @mensajeUsuarioResultado OUTPUT, @mensajeTecnicoResultado = @mensajeTecnicoResultado OUTPUT, @estadoResultado = @estadoResultado OUTPUT;
        END
