...
/****** Object:  StoredProcedure [dbo].[usp_validar_estudiante_exista_por_id]    Script Date: 24/07/2026 7:45:29 p. m. ******/
DROP PROCEDURE IF EXISTS [dbo].[usp_validar_estudiante_exista_por_id]
GO
