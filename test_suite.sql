...
BEGIN
    SET @idArea = NEWID();
    INSERT INTO dbo.Area (id, nombre, codigo) VALUES (@idArea, 'Area Test', 'AT01');
END
...
BEGIN
    ...
    INSERT INTO dbo.Componente (id, nombre, codigo) VALUES (@idComponente, 'Componente Test', 'CT01');
END
