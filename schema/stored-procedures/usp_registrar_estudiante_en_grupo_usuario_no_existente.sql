...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            ELSE
            BEGIN
                SAVE TRANSACTION sp_reg_est_grupo;
        ...
        -- PASO 6: Preparación del resultado de éxito antes de finalizar la transacción propia.
        ...
        -- PASO 7: Finalización de la transacción respetando ownership (ver docs/procedimiento-transacciones)
        ...
        BEGIN
            IF XACT_STATE() = 1 AND @estadoResultado = 0
                ROLLBACK TRANSACTION sp_reg_est_grupo;
