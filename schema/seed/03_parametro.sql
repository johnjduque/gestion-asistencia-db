...
USING (VALUES
    ...
    ('PERFIL', 'CODIGO_ESTUDIANTE', 'ES', 'STRING', 'ES'),
    ('PERFIL', 'CODIGO_DOCENTE', 'DO', 'STRING', 'DO'),
    ('PERFIL', 'CODIGO_COORDINADOR', 'CD', 'STRING', 'CD'),
    ('PERFIL', 'CODIGO_DECANO', 'DE', 'STRING', 'DE'),
